...
function readMore(e) {
    function t(e, t, o) {
        ...
        function i() {
            o.debug("setLessAndMoreText"), r.lessText = e("limitTo")(r.hmText, r.hmLimit), r.moreText = e("limitTo")(r.hmText, a())
        }

        function h() {
            o.debug("initialize"), s(), n(), l(), i(), g(), m()
        }
        var r = this;
        r.toggle = {
            dots: "...",
            ...
            e != t && (o.debug("hmText changed"), l(), i(), g())
        }), t.$watch("vm.hmLimit", function (e, t) {
            e != t && (o.debug("hmLimit changed"), l(), i(), g())
        })
    }
    var o = {
        restrict: "AE",
